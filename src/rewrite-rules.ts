...
export const RTK_REWRITE_RULES: RtkRewriteRule[] = [
	...
	},
	{
		...
		category: "filesystem",
		matcher: /^bash\s+(.+)$/i,
		replacement: "rtk proxy bash $1",
		description: "bash -> proxy",
	},
	...
	// JavaScript / TypeScript ecosystem
	{
		id: "vitest",
		category: "javascript",
		matcher: /^vitest(?:\s+run)?\b/,
		replacement: "rtk vitest run",
		description: "vitest",
	},
	{
		id: "npx-vitest",
		category: "javascript",
		matcher: /^npx\s+vitest(?:\s+run)?\b/,
		replacement: "rtk vitest run",
		description: "npx vitest",
	},
	{
		id: "bunx-vitest",
		category: "javascript",
		matcher: /^bunx\s+vitest(?:\s+run)?\b/,
		replacement: "rtk vitest run",
	...
	},
	{
		id: "pnpm-vitest",
		category: "javascript",
		matcher: /^pnpm\s+(?:exec\s+)?vitest(?:\s+run)?\b/,
		replacement: "rtk vitest run",
		description: "pnpm vitest",
	},
	{
		id: "npm-run",
		category: "javascript",
	...
	},
	{
		id: "bunx-tsc",
		category: "javascript",
		matcher: /^bunx\s+tsc\b/,
		replacement: "rtk tsc",
		description: "bunx tsc",
	},
	{
		id: "pnpm-tsc",
		category: "javascript",
		matcher: /^pnpm\s+(?:exec\s+)?tsc\b/,
		replacement: "rtk tsc",
		description: "pnpm tsc",
	},
	{
		id: "pnpm-typecheck",
		category: "javascript",
		matcher: /^pnpm\s+typecheck\b/,
		replacement: "rtk tsc",
	...
	},
	{
		...
		category: "javascript",
		matcher: /^eslint\b/,
		replacement: "rtk lint",
		description: "eslint",
	},
	{
		id: "npx-eslint",
		category: "javascript",
		matcher: /^npx\s+eslint\b/,
		replacement: "rtk lint",
		description: "npx eslint",
	},
	{
		id: "bunx-eslint",
		category: "javascript",
		matcher: /^bunx\s+eslint\b/,
		replacement: "rtk lint",
		description: "bunx eslint",
	},
	{
		id: "pnpm-lint",
		category: "javascript",
		matcher: /^pnpm\s+lint\b/,
		replacement: "rtk lint",
	...
	},
	{
		...
		category: "javascript",
		matcher: /^next\b/,
		replacement: "rtk next",
		description: "next",
	},
	{
		id: "npx-next",
		category: "javascript",
		matcher: /^npx\s+next\b/,
		replacement: "rtk next",
		description: "npx next",
	},
	{
		id: "bunx-next",
		category: "javascript",
		matcher: /^bunx\s+next\b/,
		replacement: "rtk next",
		description: "bunx next",
	},
	{
		id: "prettier",
		category: "javascript",
		matcher: /^prettier\b/,
		replacement: "rtk prettier",
		description: "prettier",
	},
	{
		id: "npx-prettier",
		category: "javascript",
		matcher: /^npx\s+prettier\b/,
		replacement: "rtk prettier",
		description: "npx prettier",
	},
	{
		id: "bunx-prettier",
		category: "javascript",
		matcher: /^bunx\s+prettier\b/,
		replacement: "rtk prettier",
		description: "bunx prettier",
	},
	{
		id: "playwright",
		category: "javascript",
		matcher: /^playwright\b/,
		replacement: "rtk playwright",
		description: "playwright",
	},
	{
		id: "npx-playwright",
		category: "javascript",
		matcher: /^npx\s+playwright\b/,
		replacement: "rtk playwright",
		description: "npx playwright",
	},
	{
		id: "bunx-playwright",
		category: "javascript",
		matcher: /^bunx\s+playwright\b/,
		replacement: "rtk playwright",
		description: "bunx playwright",
	},
	{
		id: "pnpm-playwright",
		category: "javascript",
		matcher: /^pnpm\s+playwright\b/,
		replacement: "rtk playwright",
		description: "pnpm playwright",
	},
	{
		id: "prisma",
		category: "javascript",
		matcher: /^prisma\b/,
		replacement: "rtk prisma",
		description: "prisma",
	},
	{
		id: "npx-prisma",
		category: "javascript",
		matcher: /^npx\s+prisma\b/,
		replacement: "rtk prisma",
		description: "npx prisma",
	},
	{
		id: "bunx-prisma",
		category: "javascript",
		matcher: /^bunx\s+prisma\b/,
		replacement: "rtk prisma",
		description: "bunx prisma",
	},
	{
		id: "pnpm-prisma",
		category: "javascript",
		matcher: /^pnpm\s+prisma\b/,
		replacement: "rtk prisma",
		description: "pnpm prisma",
	},
	{
		id: "bun-proxy",
		category: "javascript",
		matcher: /^bun\s+(.+)$/,
		replacement: "rtk proxy bun $1",
		description: "bun -> proxy",
	},
	{
		id: "node-proxy",
		category: "javascript",
		matcher: /^node\s+(.+)$/,
		replacement: "rtk proxy node $1",
	...
	},
	{
		...
		category: "javascript",
		matcher: /^tsx\s+(.+)$/,
		replacement: "rtk proxy tsx $1",
		description: "tsx -> proxy",
	},
	{
		id: "npx-proxy",
		category: "javascript",
		matcher: /^npx\s+(.+)$/,
		replacement: "rtk proxy npx $1",
		description: "npx fallback -> proxy",
	},
	{
		id: "bunx-proxy",
		category: "javascript",
		matcher: /^bunx\s+(.+)$/,
		replacement: "rtk proxy bunx $1",
		description: "bunx fallback -> proxy",
	},
	...
	// Python
	{
		...
		category: "python",
		matcher: /^pytest\b/,
		replacement: "rtk pytest",
		description: "pytest",
	},
	{
		id: "python-pytest",
		category: "python",
		matcher: /^python(?:3(?:\.\d+)?)?\s+-m\s+pytest\b/,
		replacement: "rtk pytest",
	...
	},
	{
		...
		category: "python",
		matcher: /^ruff\b/,
		replacement: "rtk ruff",
		description: "ruff",
	},
	{
		id: "python-ruff",
		category: "python",
		matcher: /^python(?:3(?:\.\d+)?)?\s+-m\s+ruff\b/,
		replacement: "rtk ruff",
		description: "python -m ruff",
	},
	{
		id: "pip",
		category: "python",
	...
	},
	{
		...
		category: "python",
		matcher:
			/^python(?:3(?:\.\d+)?)?\s+-m\s+pip\s+(list|outdated|install|uninstall|show)\b/,
		replacement: "rtk pip $1",
	...
	},
	{
		...
		category: "python",
		matcher: /^poetry\s+(.+)$/,
		replacement: "rtk proxy poetry $1",
		description: "poetry -> proxy",
	},
	...
	// Go
	{
		...
		category: "go",
		matcher: /^go\s+(.+)$/,
		replacement: "rtk go $1",
		description: "go <args> -> rtk go",
	},
	{
		id: "golangci",
		category: "go",
		matcher: /^golangci-lint\b/,
		replacement: "rtk golangci-lint",
